...
%datasets = {'Rain100H'};
datasets = {'rain_100L'};%,'rain_100L','rain_100H','Rain200L', 'Rain200H','DID'};
% datasets = {'Rain200L', 'Rain200H', 'SPA-Data','DID"};
num_set = length(datasets);

psnr_alldatasets = 0;
ssim_alldatasets = 0;
for idx_set = 1:num_set
    file_path = strcat('./results/', datasets{idx_set}, '/test/');
    gt_path = strcat('./Datasets/rain/', datasets{idx_set}, '/test/gt/');
